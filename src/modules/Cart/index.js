      ...
      <div className="flex shadow-md my-10">
        <div className="w-3/4 bg-white px-10 py-10">
          <div className="flex justify-between border-b pb-8">
            <h1 className="font-semibold text-2xl">Book Cart</h1>
            <h2 className="font-semibold text-2xl">{carts?.length}  </h2>
          </div>
          <div className="flex mt-10 mb-5">
            <h3 className="font-semibold text-gray-600 text-xs uppercase w-2/5">Book Details</h3>
            <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/5">Author</h3>
            <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/5">Borrow Date</h3>
            <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/5">Validity End Date</h3>
          </div>
          {
            carts?.map(cart => {
              return (
                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                  <div className="flex w-2/5">
                    ...
                    <div className="flex flex-col justify-between ml-4 flex-grow">
                      ...
                      <div className="font-semibold hover:text-red-500 text-gray-500 text-xs cursor-pointer" onClick={() => removeBook(cart?.id)}>Remove</div>
                    </div>
                  </div>
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div className="flex justify-between mt-10 mb-5">
            <span className="font-semibold text-sm uppercase">Books {carts?.length}</span>
